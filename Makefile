...
CXXFLAGS = -g -O0 -ffast-math -march=i686 -D_WIN32_WINNT=0x0501 -I/usr/i586-mingw32msvc/include -ffast-math -mmmx
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -L./lua/ -llua -lagl -lalleg -luser32 -lgdi32 -lopengl32 -lglu32 -lz.dll -lfmodex -lws2_32
LTLIBOBJS = 
