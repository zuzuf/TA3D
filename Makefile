...
CXXFLAGS = -g -O0 -march=athlon64 -I/usr/local/include -rdynamic -ffast-math -mmmx
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lfmodex64 -lz -lGLU -lGL  -lagl -L./lua/ -llua -L./hawknl/src/ -lNL -L/usr/local/lib -Wl,--export-dynamic -lalleg-4.2.2 -lalleg_unsharable
LTLIBOBJS = 
...
STRIP = 
VERSION = 0.5.0
abs_builddir = /home/roland/progc++/ta3d
abs_srcdir = /home/roland/progc++/ta3d
