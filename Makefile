...
CXXFLAGS = -g -O0 -p -march=nocona -I/usr/local/include -ffast-math -mmmx
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lfmodex64 -lz -lGLU -lGL  -L/usr/local/lib -Wl,--export-dynamic -lalleg-4.2.2 -lalleg_unsharable -lagl -L./lua/ -llua
LTLIBOBJS = 
