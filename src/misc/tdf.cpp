...
namespace TA3D
{
    ...
    static int parserExpected(const String& tag, TDFParser& p, const String& key, const String& expectedValue)
    {
    ...
    static int TDFParserSimpleTest()
    {
        int ret = 0;
        String data;
        data << "[root]\n"
    ...
    static int TDFParserNestedTest()
    {
        int ret = 0;
        String data;
        data << "[root]\n"
    ...
    static int TDFParserGadgetModeTest()
    {
        int ret = 0;
        String data;
        data << "[root]\n"
