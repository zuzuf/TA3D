...
void SurfEdit()
{
	...
	surface_area.caption("surface.t_mred", format("%d",(int)(obj_table[cur_part]->surface.Color[0]*255.0f)) );
	surface_area.caption("surface.t_mgreen", format("%d",(int)(obj_table[cur_part]->surface.Color[1]*255.0f)) );
	surface_area.caption("surface.t_mblue", format("%d",(int)(obj_table[cur_part]->surface.Color[2]*255.0f)) );
	surface_area.caption("surface.t_malpha", format("%d",(int)(obj_table[cur_part]->surface.Color[3]*255.0f)) );

	surface_area.set_state("surface.c_reflection", obj_table[cur_part]->surface.Flag&SURFACE_REFLEC );

	surface_area.caption("surface.t_rred", format("%d",(int)(obj_table[cur_part]->surface.RColor[0]*255.0f)) );
	surface_area.caption("surface.t_rgreen", format("%d",(int)(obj_table[cur_part]->surface.RColor[1]*255.0f)) );
	surface_area.caption("surface.t_rblue", format("%d",(int)(obj_table[cur_part]->surface.RColor[2]*255.0f)) );
	surface_area.caption("surface.t_ralpha", format("%d",(int)(obj_table[cur_part]->surface.RColor[3]*255.0f)) );
	...
	surface_area.caption("surface.t_angle0_x", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_0.x) : "0" );
	surface_area.caption("surface.t_angle0_y", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_0.y) : "0" );
	surface_area.caption("surface.t_angle0_z", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_0.z) : "0" );

	surface_area.caption("surface.t_angle1_x", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_1.x) : "0" );
	surface_area.caption("surface.t_angle1_y", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_1.y) : "0" );
	surface_area.caption("surface.t_angle1_z", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_1.z) : "0" );

	surface_area.caption("surface.t_translate0_x", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_0.x) : "0" );
	surface_area.caption("surface.t_translate0_y", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_0.y) : "0" );
	surface_area.caption("surface.t_translate0_z", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_0.z) : "0" );

	surface_area.caption("surface.t_translate1_x", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_1.x) : "0" );
	surface_area.caption("surface.t_translate1_y", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_1.y) : "0" );
	surface_area.caption("surface.t_translate1_z", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_1.z) : "0" );

	surface_area.caption("surface.t_angle_w", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->angle_w) : "0" );
	surface_area.caption("surface.t_translate_w", obj_table[cur_part]->animation_data ? format( "%f", obj_table[cur_part]->animation_data->translate_w) : "0" );
	...
	do
	{
		...
		{
			obj_table[cur_part]->animation_data->angle_0.x = atof( surface_area.caption("surface.t_angle0_x").c_str());
			obj_table[cur_part]->animation_data->angle_0.y = atof( surface_area.caption("surface.t_angle0_y").c_str());
			obj_table[cur_part]->animation_data->angle_0.z = atof( surface_area.caption("surface.t_angle0_z").c_str());

			obj_table[cur_part]->animation_data->angle_1.x = atof( surface_area.caption("surface.t_angle1_x").c_str());
			obj_table[cur_part]->animation_data->angle_1.y = atof( surface_area.caption("surface.t_angle1_y").c_str());
			obj_table[cur_part]->animation_data->angle_1.z = atof( surface_area.caption("surface.t_angle1_z").c_str());

			obj_table[cur_part]->animation_data->translate_0.x = atof( surface_area.caption("surface.t_translate0_x").c_str());
			obj_table[cur_part]->animation_data->translate_0.y = atof( surface_area.caption("surface.t_translate0_y").c_str());
			obj_table[cur_part]->animation_data->translate_0.z = atof( surface_area.caption("surface.t_translate0_z").c_str());

			obj_table[cur_part]->animation_data->translate_1.x = atof( surface_area.caption("surface.t_translate1_x").c_str());
			obj_table[cur_part]->animation_data->translate_1.y = atof( surface_area.caption("surface.t_translate1_y").c_str());
			obj_table[cur_part]->animation_data->translate_1.z = atof( surface_area.caption("surface.t_translate1_z").c_str());

			obj_table[cur_part]->animation_data->angle_w = atof( surface_area.caption("surface.t_angle_w").c_str());
			obj_table[cur_part]->animation_data->translate_w = atof( surface_area.caption("surface.t_translate_w").c_str());
		}
		...
		if (surface_area.get_object("surface.m_part") && surface_area.caption("surface.m_part") != surface_area.get_object("surface.m_part")->Text[cur_part+1]) // Si l'utilisateur a sélectionné une partie
		{
			surface_area.set_state("surface.c_gouraud", obj_table[cur_part]->surface.Flag&SURFACE_GOURAUD);
			surface_area.set_state("surface.c_lighting", obj_table[cur_part]->surface.Flag&SURFACE_LIGHTED);
			surface_area.set_state("surface.c_texturing", obj_table[cur_part]->surface.Flag&SURFACE_TEXTURED);
			...
			{
				surface_area.caption("surface.t_angle0_x", format( "%f", obj_table[cur_part]->animation_data->angle_0.x ) );
				surface_area.caption("surface.t_angle0_y", format( "%f", obj_table[cur_part]->animation_data->angle_0.y ) );
				surface_area.caption("surface.t_angle0_z", format( "%f", obj_table[cur_part]->animation_data->angle_0.z ) );

				surface_area.caption("surface.t_angle1_x", format( "%f", obj_table[cur_part]->animation_data->angle_1.x ) );
				surface_area.caption("surface.t_angle1_y", format( "%f", obj_table[cur_part]->animation_data->angle_1.y ) );
				surface_area.caption("surface.t_angle1_z", format( "%f", obj_table[cur_part]->animation_data->angle_1.z ) );

				surface_area.caption("surface.t_translate0_x", format( "%f", obj_table[cur_part]->animation_data->translate_0.x ) );
				surface_area.caption("surface.t_translate0_y", format( "%f", obj_table[cur_part]->animation_data->translate_0.y ) );
				surface_area.caption("surface.t_translate0_z", format( "%f", obj_table[cur_part]->animation_data->translate_0.z ) );

				surface_area.caption("surface.t_translate1_x", format( "%f", obj_table[cur_part]->animation_data->translate_1.x ) );
				surface_area.caption("surface.t_translate1_y", format( "%f", obj_table[cur_part]->animation_data->translate_1.y ) );
				surface_area.caption("surface.t_translate1_z", format( "%f", obj_table[cur_part]->animation_data->translate_1.z ) );

				surface_area.caption("surface.t_angle_w", format( "%f", obj_table[cur_part]->animation_data->angle_w ) );
				surface_area.caption("surface.t_translate_w", format( "%f", obj_table[cur_part]->animation_data->translate_w ) );
			...
			{
				surface_area.caption("surface.t_angle0_x", "0" );
				surface_area.caption("surface.t_angle0_y", "0" );
				surface_area.caption("surface.t_angle0_z", "0" );

				surface_area.caption("surface.t_angle1_x", "0" );
				surface_area.caption("surface.t_angle1_y", "0" );
				surface_area.caption("surface.t_angle1_z", "0" );

				surface_area.caption("surface.t_translate0_x", "0" );
				surface_area.caption("surface.t_translate0_y", "0" );
				surface_area.caption("surface.t_translate0_z", "0" );

				surface_area.caption("surface.t_translate1_x", "0" );
				surface_area.caption("surface.t_translate1_y", "0" );
				surface_area.caption("surface.t_translate1_z", "0" );

				surface_area.caption("surface.t_angle_w", "0" );
				surface_area.caption("surface.t_translate_w", "0" );
		...
		obj_table[cur_part]->surface.Color[0]=atoi(surface_area.caption("surface.t_mred").c_str())/255.0f;
		obj_table[cur_part]->surface.Color[1]=atoi(surface_area.caption("surface.t_mgreen").c_str())/255.0f;
		obj_table[cur_part]->surface.Color[2]=atoi(surface_area.caption("surface.t_mblue").c_str())/255.0f;
		obj_table[cur_part]->surface.Color[3]=atoi(surface_area.caption("surface.t_malpha").c_str())/255.0f;
		...
		if (surface_area.get_state("surface.c_reflection"))
		{
			...
			obj_table[cur_part]->surface.RColor[0]=atoi(surface_area.caption("surface.t_rred").c_str())/255.0f;
			obj_table[cur_part]->surface.RColor[1]=atoi(surface_area.caption("surface.t_rgreen").c_str())/255.0f;
			obj_table[cur_part]->surface.RColor[2]=atoi(surface_area.caption("surface.t_rblue").c_str())/255.0f;
			obj_table[cur_part]->surface.RColor[3]=atoi(surface_area.caption("surface.t_ralpha").c_str())/255.0f;
		}
		else
			obj_table[cur_part]->surface.Flag&=~SURFACE_REFLEC;
			...
			switch(EditMode)
			{
				case EDIT_SELTRI:			// Code pour la sélection
					startline=true;		// Pour l'outil de traçage de lignes
					{
						...
						{
							int r = painter_area.caption("tools.red").toInt32();
							int g = painter_area.caption("tools.green").toInt32();
							int b = painter_area.caption("tools.blue").toInt32();
							int a = painter_area.caption("tools.alpha").toInt32();
					...
					void glslEditor()                  // Fragment and vertex programs editor
					{
						...
						if (!obj_table[cur_part]->surface.frag_shader_src.empty())
							glsl_area.caption("glsl.fragment program", obj_table[cur_part]->surface.frag_shader_src);
						else
							glsl_area.caption("glsl.fragment program", "");

						if (!obj_table[cur_part]->surface.vert_shader_src.empty())
							glsl_area.caption("glsl.vertex program", obj_table[cur_part]->surface.vert_shader_src);
						else
							glsl_area.caption("glsl.vertex program", "");
						...
						do
						{
							...
							{
								obj_table[cur_part]->surface.frag_shader_src = glsl_area.caption("glsl.fragment program");
								obj_table[cur_part]->surface.vert_shader_src = glsl_area.caption("glsl.vertex program");
