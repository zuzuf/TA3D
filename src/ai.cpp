...
{
	if(nb_neuron<0)	return NULL;		// no NEURON ?
	int i;
...
void AI_PLAYER::scan_unit()					{	fp_scan_unit( this );	}

void AI_PLAYER::refresh_unit_weights()		{	fp_refresh_unit_weights( this );	}

void AI_PLAYER::think( MAP *map )			{	fp_think( this, map );	}
