...
void Mesh::computeAmbientOcclusion(int w, int h, Mesh *base, int precision)     // For the Mesh and each submesh, create a texture representing global occlusion generated by the mesh itself
{
    if (base == NULL)
        base = this;
