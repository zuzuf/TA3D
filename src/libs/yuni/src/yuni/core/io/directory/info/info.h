#ifndef __YUNI_CORE_IO_DIRECTORY_INFO_INFO_H__
# define __YUNI_CORE_IO_DIRECTORY_INFO_INFO_H__
...
namespace Directory
{
	...
	** int main()
	** {
	** 	Core::IO::Directory::Info info("/tmp");
	** 	for (Core::IO::Directory::Info::iterator i = info.begin(); i != info.end(); ++i)
	** 	{
	** 		std::cout << *i << std::endl;
	** 	}
	** 	return 0;
	...
	*/
	...
	public:
		...
		** \see Yuni::Core::IO::Directory::Create()
		*/
		...
		**
		** \return True if the operation succeeded False otherwise
		** \see Yuni::Core::IO::Directory::Remove()
		*/
		bool remove() const;
		...
		** \return True if the operation succeeded False otherwise
		** \see Yuni::Core::IO::Directory::Copy()
		*/
		...
		**
		** \return True if the operation succeeded False otherwise
		** \see Yuni::Core::IO::Directory::Current::Set()
		*/
...
#endif // __YUNI_CORE_IO_DIRECTORY_INFO_INFO_H__
